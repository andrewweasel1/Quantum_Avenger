...
def train_booster(
    features, labels, params=None, num_boost_round=100, penalty_fp=5.0, penalty_fn=1.0
):
    ...
    return xgb.train(params, dtrain, num_boost_round=num_boost_round, obj=objective)
